...
NODES = [
    ...
    ("PHARMA_SUP_03","Divi's Labs Hyderabad","supplier",3,"pharma","India","low",24,89,91,0,20,22),
...
EDGES = [
    ("AUTO_SUP_01","AUTO_MFG_01",22,3,"truck",500,480),
    ("AUTO_SUP_02","AUTO_MFG_01",18,14,"sea",800,750),
    ("AUTO_SUP_03","AUTO_MFG_02",20,10,"air",300,290),
    ("AUTO_SUP_04","AUTO_MFG_01",72,20,"sea",600,700),
    ("AUTO_MFG_01","AUTO_DIST_01",30,2,"truck",1000,950),
    ("AUTO_MFG_02","AUTO_DIST_01",28,2,"truck",800,780),
    ("AUTO_DIST_01","AUTO_RET_01",25,1,"truck",900,880),
    ("AUTO_LOG_01","AUTO_DIST_01",15,5,"air",200,190),
    ("PHARMA_SUP_01","PHARMA_MFG_01",78,25,"sea",400,600),
    ("PHARMA_SUP_02","PHARMA_MFG_01",16,12,"sea",700,680),
    ("PHARMA_SUP_03","PHARMA_MFG_02",24,2,"truck",500,490),
    ("PHARMA_MFG_01","PHARMA_DIST_01",32,3,"truck",800,780),
    ("PHARMA_MFG_02","PHARMA_DIST_01",30,3,"truck",600,590),
    ("PHARMA_DIST_01","PHARMA_RET_01",25,1,"truck",900,880),
    ("PHARMA_REG_01","PHARMA_MFG_01",10,30,"none",999,999),
    ("ELEC_SUP_01","ELEC_MFG_01",80,30,"sea",200,500),
    ("ELEC_SUP_02","ELEC_MFG_01",45,7,"sea",400,390),
    ("ELEC_SUP_03","ELEC_MFG_02",74,20,"sea",350,340),
    ("ELEC_MFG_01","ELEC_DIST_01",28,2,"truck",600,580),
    ("ELEC_MFG_02","ELEC_DIST_02",26,3,"air",500,490),
    ("ELEC_DIST_01","ELEC_RET_01",22,1,"truck",700,690),
    ("ELEC_DIST_02","ELEC_RET_01",18,2,"air",400,390),
]
...
def seed():
    ...
    c.executemany("""
        INSERT INTO edges (source_id,target_id,risk_score,lead_days,transport,volume,demand)
        VALUES (?,?,?,?,?,?,?)
    """, EDGES)
    conn.commit()
    conn.close()
